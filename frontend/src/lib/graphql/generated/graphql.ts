...
export type GetLeaderboardTeamsQuery = { leaderboardTeams: Array<{ _id: string, name: string, bannerColor: string, bannerIcon: string, completedMissionIds: Array<string> }> };
