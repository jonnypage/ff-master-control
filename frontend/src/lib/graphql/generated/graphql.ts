...
export type GetTeamsForStoreQuery = { teams: Array<{ _id: string, name: string, teamCode: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissionIds: Array<string> }> };
...
export type GetTeamsQuery = { teams: Array<{ _id: string, name: string, teamCode: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null }> };
...
export type GetTeamByIdQuery = { teamById?: { _id: string, name: string, teamCode: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
...
export type GetTeamsForMissionCompletionQuery = { teams: Array<{ _id: string, name: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissionIds: Array<string> }> };
...
export type MyTeamQuery = { myTeam?: { _id: string, name: string, teamCode: string, teamGuid: string, pin?: string | null, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
