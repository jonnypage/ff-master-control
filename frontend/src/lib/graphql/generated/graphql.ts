...
export type GetMissionsQuery = { missions: Array<{ _id: string, name: string, description?: string | null, creditsAwarded: number, awardsCrystal: boolean, isFinalChallenge: boolean, missionDuration: number, missionNumber: number, createdAt: any, updatedAt: any }> };
...
export type GetMissionQuery = { mission?: { _id: string, name: string, isFinalChallenge: boolean, createdAt: any, updatedAt: any, creditsAwarded: number, description?: string | null, awardsCrystal: boolean, missionDuration: number, missionNumber: number } | null };
...
export type CreateMissionMutation = { createMission: { _id: string, name: string, description?: string | null, creditsAwarded: number, awardsCrystal: boolean, isFinalChallenge: boolean, missionNumber: number } };
