...
export type TeamLoginMutation = { teamLogin: { access_token: string, team: { _id: string, name: string, teamGuid: string, image?: { url?: string | null } | null } } };
...
export type GetTeamsQuery = { teams: Array<{ _id: string, name: string, teamGuid: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null }> };
...
export type GetTeamByIdQuery = { teamById?: { _id: string, name: string, teamGuid: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
...
export type CreateTeamMutation = { createTeam: { _id: string, name: string, teamGuid: string, image?: { url?: string | null } | null } };
...
export type MyTeamQuery = { myTeam?: { _id: string, name: string, teamGuid: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
