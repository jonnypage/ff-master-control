...
export type LeaderboardTeam = {
  _id: Scalars['ID']['output'];
  completedMissionIds: Array<Scalars['ID']['output']>;
...
export type GetLeaderboardTeamsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLeaderboardTeamsQuery = { leaderboardTeams: Array<{ _id: string, name: string, completedMissionIds: Array<string> }> };
...
export type GetTeamsForStoreQuery = { teams: Array<{ _id: string, name: string, credits: number }> };
...
export type AdjustCreditsMutation = { adjustCredits: { _id: string, name: string, credits: number } };
...
export type TeamLoginMutation = { teamLogin: { access_token: string, team: { _id: string, name: string, teamGuid: string, bannerColor: string, bannerIcon: string, image?: { url?: string | null } | null } } };
...
export type GetTeamsQuery = { teams: Array<{ _id: string, name: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null }> };
...
export type GetTeamByIdQuery = { teamById?: { _id: string, name: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
...
export type CreateTeamMutation = { createTeam: { _id: string, name: string, teamGuid: string, bannerColor: string, bannerIcon: string, image?: { url?: string | null } | null } };
...
export type UpdateTeamMutation = { updateTeam: { _id: string, name: string, teamGuid: string, image?: { url?: string | null } | null } };
...
export type AddCreditsMutation = { addCredits: { _id: string, credits: number } };
...
export type RemoveCreditsMutation = { removeCredits: { _id: string, credits: number } };
...
export type GetMissionsQuery = { missions: Array<{ _id: string, name: string, description?: string | null, creditsAwarded: number, isFinalChallenge: boolean, createdAt: any, updatedAt: any }> };

export type GetTeamsForMissionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTeamsForMissionsQuery = { teams: Array<{ _id: string, completedMissionIds: Array<string> }> };
...
export type GetMissionQuery = { mission?: { _id: string, name: string, description?: string | null, creditsAwarded: number, isFinalChallenge: boolean } | null };
...
export type UpdateMissionMutation = { updateMission: { _id: string, name: string, description?: string | null, creditsAwarded: number, isFinalChallenge: boolean } };

export type GetTeamsForMissionQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTeamsForMissionQuery = { teams: Array<{ _id: string, completedMissionIds: Array<string> }> };

export type GetTeamsForMissionCompletionQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTeamsForMissionCompletionQuery = { teams: Array<{ _id: string, name: string, credits: number, completedMissionIds: Array<string> }> };
...
export type MyTeamQuery = { myTeam?: { _id: string, name: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
...
export type CreateMissionMutation = { createMission: { _id: string, name: string, description?: string | null, creditsAwarded: number, isFinalChallenge: boolean } };

export type GetMissionsForTeamEditQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMissionsForTeamEditQuery = { missions: Array<{ _id: string, name: string }> };
...
export const GetLeaderboardTeamsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLeaderboardTeams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"leaderboardTeams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"completedMissionIds"}}]}}]}}]} as unknown as DocumentNode<GetLeaderboardTeamsQuery, GetLeaderboardTeamsQueryVariables>;
...
export const RemoveCreditsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveCredits"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"teamId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"amount"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeCredits"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"teamId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"teamId"}}},{"kind":"Argument","name":{"kind":"Name","value":"amount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"amount"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"credits"}}]}}]}}]} as unknown as DocumentNode<RemoveCreditsMutation, RemoveCreditsMutationVariables>;
