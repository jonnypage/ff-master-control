...
export type MyTeamQuery = { myTeam?: { _id: string, name: string, teamCode: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, completedMissionIds: Array<string>, image?: { url?: string | null } | null } | null };
