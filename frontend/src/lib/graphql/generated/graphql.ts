...
export type CompletedMission = {
  ...
  crystalsReceived?: Maybe<Scalars['Float']['output']>;
...
export type LeaderboardTeamsQuery = { leaderboardTeams: Array<{ _id: string, name: string, bannerColor: string, bannerIcon: string, completedMissions: Array<{ missionId: string, completedAt: any }> }> };
...
export type GetTeamsForStoreQuery = { teams: Array<{ _id: string, name: string, teamCode: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissions: Array<{ missionId: string }> }> };
...
export type GetTeamsQuery = { teams: Array<{ _id: string, name: string, teamCode: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, image?: { url?: string | null } | null, completedMissions: Array<{ missionId: string }> }> };
...
export type GetTeamByIdQuery = { teamById?: { _id: string, name: string, teamCode: string, teamGuid: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, image?: { url?: string | null } | null, completedMissions: Array<{ missionId: string }> } | null };
...
export type GetTeamsForMissionsQuery = { teams: Array<{ _id: string, completedMissions: Array<{ missionId: string }> }> };
...
export type GetTeamsForMissionQuery = { teams: Array<{ _id: string, completedMissions: Array<{ missionId: string }> }> };

export type GetTeamsForMissionCompletionQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTeamsForMissionCompletionQuery = { teams: Array<{ _id: string, name: string, bannerColor: string, bannerIcon: string, credits: number, crystals: number, completedMissions: Array<{ missionId: string }> }> };
...
export type MyTeamQuery = { myTeam?: { _id: string, name: string, teamCode: string, teamGuid: string, pin?: string | null, bannerColor: string, bannerIcon: string, credits: number, crystals: number, image?: { url?: string | null } | null, completedMissions: Array<{ missionId: string }> } | null };
