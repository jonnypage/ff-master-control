 ...
 */
type Documents = {
    "\n          query LeaderboardTeams {\n            leaderboardTeams {\n              _id\n              name\n              bannerColor\n              bannerIcon\n              missions {\n                missionId\n                status\n                completedAt\n              }\n            }\n          }\n        ": typeof types.LeaderboardTeamsDocument,
...
const documents: Documents = {
    "\n          query LeaderboardTeams {\n            leaderboardTeams {\n              _id\n              name\n              bannerColor\n              bannerIcon\n              missions {\n                missionId\n                status\n                completedAt\n              }\n            }\n          }\n        ": types.LeaderboardTeamsDocument,
    ...
    "\n          mutation FailMission($missionId: ID!, $teamId: ID!) {\n            failMission(missionId: $missionId, teamId: $teamId) {\n              _id\n              name\n            }\n          }\n        ": types.FailMissionDocument,
    "\n          mutation AdjustMissionTime($missionId: ID!, $teamId: ID!, $minutes: Float!) {\n            adjustMissionTime(missionId: $missionId, teamId: $teamId, minutes: $minutes) {\n              _id\n              name\n            }\n          }\n        ": types.AdjustMissionTimeDocument,
